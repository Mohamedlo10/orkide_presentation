...
const AboutSection = () => {
  ...
  return (
    <section className="text-white md:h-[100vh]  flex items-center justify-center" id="about">
      <div className="md:grid md:grid-cols-2 md:gap-8  items-center justify-center px-4 xl:gap-16 md:py-10 xl:px-2">
        <Image src="/logo.svg" width={500} height={500} className="hidden md:block" />
        <div className="md:pt-12 md:mt-0 text-left items-center justify-center flex flex-col h-full">
